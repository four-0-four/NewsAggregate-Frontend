        ...
        <>
            <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-black text-white min-h-[50px] flex items-center">
                <ul className="flex justify-evenly w-full">
                    <Link href="/" className={`flex items-center text-xs sm:text-md p-1 px-2 sm:p-2 sm:px-3 text-center rounded-[20px] ${isActive('/') ? 'bg-neutral-700 text-neutral-300' : 'text-neutral-300'}`}>
                    ...
                    <Link href="/explore" className={`flex items-center text-xs sm:text-md p-1 px-2 sm:p-2 sm:px-3 text-center rounded-[20px]  ${isActive('/explore') ? 'bg-neutral-700 text-neutral-300' : 'text-neutral-300'}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="hidden w-5 h-5 sm:inline-block mr-2">
