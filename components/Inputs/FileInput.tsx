  ...
  return (
    <div className="flex flex-col mt-6">
        ...
        <div className="flex items-center justify-center w-full">
            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-[25px] cursor-pointer bg-gray-50 hover:bg-gray-100">
        ...
        {files && (
            <div className='flex gap-2 flex-wrap'>
                {files && files.map(file => (
                    <div key={file.name} className="flex flex-row cursor-pointer p-2 px-3 items-center justify-center w-fit mt-5 border border-gray-300 rounded-[25px] bg-gray-50 hover:bg-gray-100">
