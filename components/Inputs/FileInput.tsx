        ...
        {files && (
            <div className='flex gap-2 flex-wrap'>
                {files && files.map(file => (
                    <div key={file.name} className="flex flex-row cursor-pointer p-2 px-3 items-center justify-center w-fit mt-5 border border-gray-300 rounded-[20px] bg-gray-50 hover:bg-gray-100">
