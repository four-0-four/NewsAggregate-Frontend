  ...
  return (
    <div className='mt-4 xl:mt-6 w-full px-4 sm:w-full md:max-w-2xl lg:max-w-2xl xl:max-w-3xl bg-white p-6 rounded-[25px] border border-gray-100 mb-12 lg:mb-0'>
        ...
        <div className='flex flex-row flex-wrap gap-2'>
            <a href="https://www.instagram.com/farabixinc/" className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com/farabixinc" className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]" target="_blank" rel="noopener noreferrer">
            ...
            <a href="mailto:admin@farabix.com" className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]">
