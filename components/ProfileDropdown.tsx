    ...
    return (
        <div style={{ position: 'relative' }} ref={dropdownRef}>
            <button 
                ...
                className="flex items-center text-sm pe-1 font-medium text-gray-400" 
                type="button"
            >
                <span className="sr-only">Open user menu</span>
                <svg className='w-8 h-8 fill-current text-white mr-2' viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            {isDropdownOpen && (
                <div id="dropdownAvatarName" className=" mt-6 z-10 absolute right-0 bg-black text-white divide-y divide-gray-600 rounded-[25px] min-w-[200px] overflow-hidden">
                    ...
                    <ul className="py-2 text-sm" aria-labelledby="dropdownAvatarNameButton">
                        <li>
                            <Link onClick={closeDropdown} href="/profile" className="block px-4 py-2 hover:bg-gray-800 cursor-pointer">
                        ...
                        <li>
                            <Link onClick={closeDropdown} href="/contactUs" className="block px-4 py-2 hover:bg-gray-800 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 inline-block mr-2">
                    ...
                    <ul className="py-2 text-sm" aria-labelledby="dropdownAvatarNameButton">
                        <li>
                            <Link onClick={closeDropdown} href="/reportBut" className="block px-4 py-2 hover:bg-gray-800 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 inline-block mr-2">
                        ...
                        <li>
                            <Link onClick={closeDropdown} href="/requestFeature" className="block px-4 py-2 hover:bg-gray-800 cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 inline-block mr-2">
