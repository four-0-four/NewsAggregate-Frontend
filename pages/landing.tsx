        ...
        <footer className="bg-black p-5 py-3">
            <div className='max-w-[1200px] mx-auto flex flex-row items-center justify-end xs:justify-between'>
                ...
                <div className='flex flex-row flex-wrap gap-2'>
                    <a href="https://www.instagram.com/farabixinc/" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://twitter.com/farabixinc" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="mailto:admin@farabix.com" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]">
