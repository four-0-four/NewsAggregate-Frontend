    ...
    <div>
        ...
        <section className="flex flex-col sm:flex-row justify-between items-center py-8 max-w-[1200px] mx-auto px-4 xs:px-10 pt-24 md:pt-8">
            <div className="w-full sm:w-3/5 md:w-3/5 mb-4  md:pt-10 lg:pt-0">
                ...
                <button className="bg-primary text-black text-sm md:text-md lg:text-lg xl:text-xl py-2 px-6 lg:px-12 md:px-10 rounded-[25px] uppercase mt-4">
        ...
        <footer className="bg-black p-5 py-3">
            <div className='max-w-[1200px] mx-auto flex flex-row items-center justify-end xs:justify-between'>
                ...
                <div className='flex flex-row flex-wrap gap-2'>
                    <Link href="https://www.instagram.com/farabixinc/" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]" target="_blank" rel="noopener noreferrer">
                    ...
                    <Link href="https://twitter.com/farabixinc" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]" target="_blank" rel="noopener noreferrer">
                    ...
                    <Link href="mailto:admin@farabix.com" className="flex items-center gap-2 mb-1 block w-fit bg-white rounded-[25px]">
