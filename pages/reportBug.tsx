...
const reportBugForm = () => {
    ...
    return (
        <div className="flex flex-col justify-center lg:justify-start">
            ...
            <div className='mt-6 w-full px-4 sm:w-full md:max-w-2xl lg:max-w-2xl xl:max-w-3xl bg-white p-6 rounded-[25px] border border-gray-100 '>
              <h1 className={`text-lg sm:text-xl md:text-2xl font-bold text-left uppercase pb-4 font-light`}>
                Other Ways to Reach Us
              </h1>
              <div className='flex flex-row flex-wrap gap-2'>
                <span className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 24 24" className="mr-1 w-10 h-10 rounded-full text-primary border-2 border-primary fill-primary p-1">
                ...
                <span className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]">
                    <svg xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 462.799" className="w-10 h-10 rounded-full text-primary border-2 border-primary fill-primary p-1 mr-1">
                ...
                <span className="flex items-center gap-2 mb-1 block w-fit pr-4 bg-gray-100 p-2 rounded-[25px]">
                    <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"  className="w-10 h-10 rounded-full text-primary border-2 border-primary p-1 mr-1">
