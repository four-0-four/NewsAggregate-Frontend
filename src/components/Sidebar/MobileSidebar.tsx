            ...
            <div>
                ...
                <nav className="absolute bottom-0 left-0 right-0 py-2 mx-2 border-t border-neutral-100">
                    <ul className="flex w-full">
                        <a href="/TermsOfService" className="flex-1 text-center text-neutral-200 cursor-pointer hover:underline text-xs xl:text-sm border-r border-neutral-100">
                            Terms of Service
                        </a>
                        <a href="/PrivacyPolicy" className="flex-1 text-center text-neutral-200 cursor-pointer hover:underline text-xs xl:text-sm">
                            Privacy Policy
                        </a>
                    </ul>
                </nav>
