...
const ContactSidebar = (props: Props) => {
        ...
        <>
            ...
            <nav className='mb-4'>
                <ul>
                    ...
                    <SidebarElement href="/contact/reportBug" icon={<BugIcon />}>
                        Report a Bug
                    </SidebarElement>
                    <SidebarElement href="/contact/requestFeature" icon={<FeatureIcon />}>
                        Request a Feature
                    </SidebarElement>
                </ul>
            </nav>
