    ...
    <div className='flex flex-col items-center'>
        <div className='relative'>
            ...
            {props.actionType.toLowerCase() === 'remove' && (
                <button onClick={()=>props.action(props.id)} className='absolute top-[0rem] right-[-0.2rem] text-sm rounded-full bg-black text-white h-5 w-5 sm:h-5 sm:w-5 flex items-center justify-center'>
            ...
            {props.actionType.toLowerCase() === 'add' && (
                <button onClick={()=>props.action(props.id)} className='absolute top-[0rem] right-[-0.2rem] text-md rounded-full bg-primary text-black h-5 w-5 sm:h-5 sm:w-5 flex items-center justify-center'>
