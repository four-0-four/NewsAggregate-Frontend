  ...
  return (
    <div className='columns-4'>
        ...
        <div className='border-b border-gray-300'>
            ...
            <p className='text-left text-xs mb-4'><span className="font-bold">Inclusive Platform:</span> A welcoming space for journalists from all backgrounds committed to truth and storytelling.</p>
            <p className='text-left text-xs mb-4'><span className="font-bold">Verification and Validation:</span> Rigorous verification ensures that only verified professional journalists share news.</p>
        ...
        <div className='border-b border-gray-300'>
            ...
            <p className='text-left text-xs mb-4'>If you're a journalist passionate about making a difference in the world, we invite you to join our mission. Submit your email, and we'll get in touch as we gear up for launch!</p>
...
prioritizing truth and transparency</p>
            <p className='text-left text-xs mb-4'><span className="font-bold">Safeguard and Raise the Quality of News:</span>
Aim to implement a robust journalist verification system before publishing with a subsequent peer review system to evaluate published news</p>
            <p className='text-left text-xs mb-4'><span className="font-bold">Empower Journalists with Financial Independence:</span>
 Endeavor to create multiple income avenues in the long term for independent journalists, facilitating complete financial self-sufficiency. This enables them to further their journalistic passion and concentrate more intensively on their craft.</p>
        </div>
        <div className="">
